...
function ViewOne() {
  return (
    <div>
      ...
      >
        <div>
          <h2 className="text-3xl py-10 font-semibold">Calzado</h2>
          <p>
        ...
        <div className="bg-red-300 flex justify-center items-center rounded-xl">
          <div className="relative w-56 h-56">
            <Suspense fallback={<Loading />}>
              <Image src="/zapatillas.png" alt="zapatilla" fill></Image>
            </Suspense>
          </div>
        </div>
      </Link>
